...
import { EthereumManager } from '../cli/EthereumManager';
...
const pk = process.env.TEST_WALLET_KEY // 0xe710597dE7cd68A8F9938dDfe7140f3fDf39AbB0
...
describe('generateNewWallet', () => {
  it('generateNewWallet is working', (done) => {
    new Promise((resolve, reject) => {
      ...
      const em = new EthereumManager(eh);
